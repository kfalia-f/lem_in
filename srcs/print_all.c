...
/*
File print_all.c
В этом файле производится вывовод информации о карте: количество муравьев, количество комнат, количество полученных строк
информации о связях каждой комнате и ее статусе (0 - обычная комната, 1 - старт, 2 - конец)
*/
